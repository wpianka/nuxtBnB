...
export default {
  head() {
    return {
      ...
      script: [{
        src: "https://maps.googleapis.com/maps/api/js?key=AIzaSyBEepxalX-CBi-x4ioucYzivZ7dHmYT3nw&libraries=places",
        hid: "map",
        defer: true,
      }]
    }
  ...
  created() {
    const first = homes.find((home) => home.objectID ==  this.$route.params.id)
    this.home = first
  }
}
</script>
